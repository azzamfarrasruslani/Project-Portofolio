...
const highlights = [
  {
    icon: require("@fortawesome/free-solid-svg-icons").faBolt,
    text: "Fast Learner",
  },
  {
    icon: require("@fortawesome/free-solid-svg-icons").faCode,
    text: "Clean & Efficient Code",
  },
  {
    icon: require("@fortawesome/free-solid-svg-icons").faUsers,
    text: "Great Team Player",
  },
  {
    icon: require("@fortawesome/free-solid-svg-icons").faRocket,
...
export default function AboutPage() {
  return (
    ...
    >
      ...
      >
        I’m <span className="text-[#cceb6c] font-semibold">Azzam FR</span>, a
        passionate Informatics Engineering student who thrives on building
        impactful and modern web solutions with clean and efficient code.
      </motion.p>
